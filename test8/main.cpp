...
const std::string MODEL_PATH = "textures/chalet.obj";
	...
	private:
				...
				VDeleter<VkBuffer> &buffer, VDeleter<VkDeviceMemory> &bufferMemory)
		{
			...
			if(vkAllocateMemory(device, &allocInfo, nullptr, &bufferMemory) != VK_SUCCESS){
				throw std::runtime_error("faile to allocate buffer memory!");
			}
		...
		void updateUniformBuffer()
		{
			...
			x = 2.0f * std::cos(time * glm::radians(90.0f));
			y = 2.0f * std::sin(time * glm::radians(90.0f));

			UniformBufferObject ubo = {};
			ubo.model = glm::rotate(glm::mat4(), glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 0.1f));
			ubo.view = glm::lookAt(glm::vec3( x, y, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
